...
<main role="main"><!--MAIN CONTENT-->
    ...
    <?php   $args = array(
            ...
            $homeChilds = new WP_Query($args); ?>

    <?php if ($homeChilds->have_posts()) : ?>
        ...
        <?php while ($homeChilds->have_posts()): $homeChilds->the_post(); ?>

            <div class="col-sm-4 <?php post_class(); ?>">
