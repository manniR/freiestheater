                    ...
                    <div id="collapse<?= $post->ID; ?>" class="panel-collapse">
                        ...
                        <div class="termine">
                            <?php foreach($events as $event): ?>
                                <div class="row">
                                    <div class="col-xs-4 paddR0"><p><?= strftime('<span class="bb">%a %d.</span> %B %Y %H:%M', date($event->datum)); ?></p></div>
                                    <div class="col-xs-8 paddL0">
                                        <div class="col-xs-4 paddLR0"><p><span class="bb"><?= $event->freie_plaetze ?></span> freie Plätze</p></div>
                                        <div class="col-xs-8 paddL0 ticket"><p><a href="#" data-eventID="<?= $event->datum_key ?>">Tickets reservieren</a></p></div>
                                    </div>
                                </div>
                            <?php endforeach; ?>
                        </div>
